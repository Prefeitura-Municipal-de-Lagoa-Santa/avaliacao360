  ...
  <DashboardLayout pageTitle="Dashboard de Avaliação">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      <DashboardCard
        ...
        iconBgColor="#10b981"
        chartPlaceholderText="Gráfico de Conclusão"
      >
        <template #icon>
      ...
      <DashboardCard
        ...
        iconBgColor="#f97316"
        chartPlaceholderText="Gráfico de Pendências"
      >
        <template #icon>
          <div v-html="ClockIcon"></div>
        </template>
      </DashboardCard>
      ...
      <DashboardCard
        ...
        iconBgColor="#6366f1"
        chartPlaceholderText="Gráfico de Progresso"
      >
        <template #icon>
          <div v-html="ChartBarIcon"></div>
        </template>
      </DashboardCard>
