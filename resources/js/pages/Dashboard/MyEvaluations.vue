        ...
        <tbody>
          <tr v-if="evaluations.length === 0">
            <td colspan="6" class="px-6 py-8 text-center text-gray-500">
              Nenhuma avaliação anual encontrada.
            </td>
          </tr>
          <tr v-for="eva in evaluations" :key="eva.year" class="bg-white border-b hover:bg-gray-50">
            ...
            <td class="px-6 py-4 text-right">
              <Link v-if="eva.id" :href="route('evaluations.details', eva.id)" class="inline-flex items-center px-3 py-1 text-sm font-medium text-indigo-600 bg-indigo-50 rounded hover:bg-indigo-100">
