...
const props = defineProps<{
    ...
    errors: Object; // Erros de validação do backend
}>();
...
const form = useForm({
    ...
    functional_status: props.person.functional_status,
    ...
    allocation_code: props.person.allocation_code,
    allocation_name: props.person.allocation_name,
});
            ...
            <form @submit.prevent="submit">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                            <div>
                                ...
                                <div v-if="form.errors.registration_number" class="text-sm text-red-600 mt-1">{{
                                    form.errors.registration_number }}</div>
                            </div>
                            <div>
                                ...
                                <div v-if="form.errors.cpf" class="text-sm text-red-600 mt-1">{{ form.errors.cpf }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                            <div>
                                <label for="rg_number" class="block text-sm font-medium text-gray-700 mb-1">RG</label>
                                <input type="text" id="rg_number" v-model="form.rg_number"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            <div>
                                <label for="functional_status"
                                    class="block text-sm font-medium text-gray-700 mb-1">Situação Funcional</label>
                                <input type="text" id="functional_status" v-model="form.functional_status"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                        </div>
                        <div>
                            <label for="allocation_code"
                                class="block text-sm font-medium text-gray-700 mb-1">Lotação - Código</label>
                            <input type="text" id="allocation_code" v-model="form.allocation_code"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                            <div>
                                <label for="admission_date" class="block text-sm font-medium text-gray-700 mb-1">Data de
                                    Admissão</label>
                                <input type="date" id="admission_date" v-model="form.admission_date"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            <div>
                                <label for="dismissal_date" class="block text-sm font-medium text-gray-700 mb-1">Data de
                                    Demissão</label>
                        ...
                        <div>
                            <label for="current_position" class="block text-sm font-medium text-gray-700 mb-1">Cargo
                                Atual</label>
                        ...
                        <div>
                            <label for="allocation_name"
                                class="block text-sm font-medium text-gray-700 mb-1">Lotação</label>
                            <input type="text" id="allocation_name" v-model="form.allocation_name"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
                </div>
...
<!-- O bloco <style> foi removido pois as classes foram aplicadas diretamente -->
