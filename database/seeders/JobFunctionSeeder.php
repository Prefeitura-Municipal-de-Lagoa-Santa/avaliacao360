...
class JobFunctionSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            ['id' => 19, 'name' => 'ASSESSOR I', 'type' => 'assessor_1', 'is_manager' => false, 'code' => 392],
            ['id' => 21, 'name' => 'ASSESSOR II', 'type' => 'assessor_1', 'is_manager' => false, 'code' => 393],
            ...
            ['id' => 27, 'name' => 'ASSESSOR DE COMUNICACAO', 'type' => 'assessor_2', 'is_manager' => false, 'code' => 411],
